...
export default function OgrencilerPage() {
  ...
  useEffect(() => {
    if (!yeniOgrenciModalAcik) return;
    const handleEsc = (e: KeyboardEvent) => {
      if (e.key === 'Escape') setYeniOgrenciModalAcik(false);
    };
        ...
        >
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <form onSubmit={handleOgrenciEkle} className="space-y-4">
              <div>
                <label htmlFor="new-student-ad" className="block text-sm font-medium text-gray-700 mb-1">Ad</label>
                <input
                  id="new-student-ad"
                  autoFocus
                  required
              ...
              <div>
                <label htmlFor="new-student-soyad" className="block text-sm font-medium text-gray-700 mb-1">Soyad</label>
                <input
                  id="new-student-soyad"
                  required
                  type="text"
                  className="w-full border border-gray-300 rounded-md p-2 text-gray-900"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="new-student-numara" className="block text-sm font-medium text-gray-700 mb-1">Numara</label>
                  <input
                    id="new-student-numara"
                    required
                    type="text"
                    className="w-full border border-gray-300 rounded-md p-2 text-gray-900"
                ...
                <div>
                  <label htmlFor="new-student-sinif" className="block text-sm font-medium text-gray-700 mb-1">Sınıf</label>
                  <input
                    id="new-student-sinif"
                    required
                    type="text"
                    className="w-full border border-gray-300 rounded-md p-2 text-gray-900"
              ...
              <div>
                <label htmlFor="new-student-veli" className="block text-sm font-medium text-gray-700 mb-1">Veli Adı (Opsiyonel)</label>
                <input
                  id="new-student-veli"
                  type="text"
                  className="w-full border border-gray-300 rounded-md p-2 text-gray-900"
